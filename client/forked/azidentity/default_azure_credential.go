...
type DisabledCredentials struct {
	ManagedIdentityCredential   bool
	WorkloadIdentityCredential  bool
	AzureCLICredential          bool
	AzureDeveloperCLICredential bool
	EnvironmentCredential       bool
}
...
func NewCustomDefaultAzureCredential(options *DefaultAzureCredentialOptions, disabledCredentials DisabledCredentials) (*DefaultAzureCredential, error) {
	...
	if !disabledCredentials.EnvironmentCredential {
	...
	if !disabledCredentials.WorkloadIdentityCredential {
	...
	if !disabledCredentials.ManagedIdentityCredential {
	...
	if !disabledCredentials.AzureCLICredential {
	...
	if !disabledCredentials.AzureDeveloperCLICredential {
